        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            {[
              ...
              { label: 'View Cow Economics',           allowed: p.canViewCowEconomics },
              { label: 'View AI Predictions',          allowed: p.canViewPredictions },
              { label: 'View Health Risk Predictions', allowed: p.canViewHealthRisks },
              { label: 'View Reproduction',            allowed: p.canViewReproduction },
              { label: 'View Feed Inventory',          allowed: p.canViewFeedInventory },
              { label: 'View Groups',                  allowed: p.canViewGroups },
              { label: 'View Tanks',                   allowed: p.canViewTanks },
              { label: 'View IoT Control',             allowed: p.canViewIotControl },
              { label: 'View Herd Analytics',          allowed: p.canViewHerdAnalytics },
